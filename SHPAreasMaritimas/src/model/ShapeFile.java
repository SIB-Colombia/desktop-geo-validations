        ...
        private void loadPolygonsInSRT(FeatureIterator<SimpleFeature> iterator) {
                ...
                if (tree == null) {
                        ...
                        try {
                                ...
                                String geometryLoadNameDescrip;
                                while (iterator.hasNext()) {

                                        SimpleFeature feature = iterator.next();
                                        geometryLoad = (Geometry) feature.getDefaultGeometry();

                                        geometryLoadNameDescrip = feature
                                                        .getAttribute(ClientConfig.getInstance().nameColumnDescrip)
                                                        + "";
    
                                        tree.insert(geometryLoad.getEnvelopeInternal(),
                                                        new NamedGeometry(geometryLoad, geometryLoadNameDescrip));
                                }
                        } finally {
                                iterator.close();
                        }
