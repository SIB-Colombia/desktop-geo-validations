...
public class ClientConfig {
	...
	private static final String XML_FILE = "client_config_municipios.xml";
	...
	private static final String XML_NOMBRE_ENT = "nombre_ent";
	...
	/**
	 * Name of the shape file column of the departamento name value
	 */
	public String nameColumnDepartamen;
	/**
	 * Name of the shape file column of the municipio name value
	 */
	public String nameColumnNombreEnt;
	/**
		...
		for (Element column : columns) {
			...
			if (name.equalsIgnoreCase(XML_FID)) {
				...
				if (name.equalsIgnoreCase(XML_DEPARTAMEN)) {
					...
					if (name.equalsIgnoreCase(XML_NOMBRE_ENT)) {
						nameColumnNombreEnt = column.getText();
					} else {
						// unknow column
					}
				}
	...
	private void createDeafaultXML() throws IOException {
		...
		shape.setAttribute(XML_PATH, "./Municipios/Shapefile/MUNICIPIOS.shp");
		...
		Element columnNombreEnt = new Element("column");
		columnNombreEnt.setAttribute(XML_NAME, XML_NOMBRE_ENT);
		columnNombreEnt.setText("NOMBRE_ENT");

		shape.addContent(columnFid);
		shape.addContent(columnDepartamen);
		shape.addContent(columnNombreEnt);
