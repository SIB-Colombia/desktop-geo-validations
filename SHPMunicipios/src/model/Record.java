...
public class Record implements Serializable {
	...
	public Record(long id, double latitude, double longitude,
	...
	public String toString() {
		return id + " " + latitude + "	" + longitude + "	" + departamento + "	"
				+ departamentoCalculado + "	" + departamentocheck + "	"
				+ municipio + "	" + municipioCalculado + "	" + municipiocheck;
	}
}
